...
def main():
    ...
    if model_v == 0 or model_v == 1:
        model_path = './logs_m_' + str(model_v) + '/t_' + str(target_v) + '/l_' + str(loss_v) + '/model-' + episode + '.pth'
    elif model_v == 2:
        model_path = './logs_m_' + str(model_v) + '/q_' + str(q_v) + '/t_' + str(target_v) + '/l_' + str(loss_v) + '/model-' + episode + '.pth'
